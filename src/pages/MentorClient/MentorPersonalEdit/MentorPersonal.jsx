...
import ClintSidebar from '../ClientSidebar/ClientSidebar.jsx';
import Navbar from '../ClientNavbar/ClientNavbar.jsx';
    ...
    return (
        <div className='flex gap-2'>
            <div className="hidden sm:block">
                <ClintSidebar liname={"Personal Info"}/>
            </div>
            <div className='flex flex-col w-full h-[100vh] overflow-y-auto py-[15px]'>
                ...
                <div className='m-[20px] text-[18px] font-[600]'>
                  <Link to={"/clientDashboard"}>Dashboard</Link> &gt; Personal Info
                </div>
                <div className='p-4 md:h-[85vh] overflow-y-auto'>
