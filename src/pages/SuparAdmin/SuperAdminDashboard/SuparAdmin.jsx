  ...
  return (
    <>
      <div className='flex'>
        ...
        <div className='w-[100%] ml-[30px] max-sm:ml-[10px]'>
          ...
          <div className='flex justify-between mt-[60px] w-[100%] max-sm:mt-[10px]'>
            <div className='flex justify-between w-[100%] max-sm:flex-col max-sm:gap-[10px]'>
              <div className='flex justify-between  text-white background1 w-[580px] max-sm:gap-0 h-[70px]  rounded-lg items-center max-sm:w-[350px] p-[5px]'>
          ...
          <div className='flex w-[100%] justify-between mt-[20px] p-[10px] max-sm:flex-col max-sm:gap-[10px]'>
            <div className='flex shadow-lg p-4 h-[170px] rounded-lg'>
