...
const MentorSkillsformentor = () => (
    <div className='flex gap-2 h-[100vh] overflow-hidden'>
        <div className="max-sm:hidden">
            <Sidebar liname={"My Account"} /> {/* Ensure this is correct usage */}
        </div>
        <div className='myAccount_body py-[15px]'>
            <Navbar Navtext={"Mentor Skills"} />
            <div className='m-[20px] text-[18px] font-[600]'>
                <Link to={"/"}>Dashboard</Link> &gt; <Link to={"/Myaccounts"}>My Account</Link> &gt;  Mentor Skills
            </div>
...
export default MentorSkillsformentor;
